...
text(-2,-1.1,pos=4,cex=0.7,font=1,
     bquote(paste("All studies(Q = ",.(formatC(pes$QE, format="f")), ", df = ", .(pes$k - pes$p),", p = ", .(formatC(pes$QEp, format="f")), 
     "; ", I^2, " = ",.(formatC(pes$I2, format="f")), "%",")")))
#Level 1 of moderator a
text(-2,11.4,pos=4,cex=0.7,font=1,
     bquote(paste("Subtotal(Q = ",.(formatC(pes.mal1$QE, format="f")), ", df = ", .(pes.mal1$k - pes.mal1$p),", p = ", .(formatC(pes.mal1$QEp, format="f")),
     "; ", I^2, " = ",.(formatC(pes.mal1$I2, format="f")), "%",")")))
#level 2 of moderator a
text(-2,1.1,pos=4,cex=0.7,font=3,
     bquote(paste("Subtotal(Q = ",.(formatC(pes.mal2$QE, format="f")),", df = ", .(pes.mal2$k - pes.mal2$p), 
