...
print(pes);print(pes.logit);confint(pes.logit)
print(pes.mal1);print(pes.logit.mal1);confint(pes.logit.mal1)
print(pes.mal2);print(pes.logit.mal2);confint(pes.logit.mal2)
```
...
pes.bb=predict(metareg.mod1,newmods=c(0:40),transf=transf.ilogit)
