...
text(-2,18.5,pos=4,cex=0.8, bquote(paste("Subtotal(Q = ",.(formatC(pes.da.mal1$QE, format="f")), ", df = ", .(pes.da.mal1$k - pes.da.mal1$p),", p = ", .(formatC(pes.da.mal1$QEp, format="f")),
"; ", I^2, " = ",.(formatC(pes.da.mal1$I2, format="f")), "%",")")))
