...
```
```{r read data files}
dat=read.csv("D:\\mydata\\ammirati.csv",header=T,sep=",")
```
```{r calculate overall effect sizes and subgroup es using the Freeman-Tukey double arcsine transformation}
#note that I changed transf.ies to ies.ft, transf.pes to pes.ft, transf.pes.m to pes.ft.endoscopy, pes.m to pes.endoscopy
