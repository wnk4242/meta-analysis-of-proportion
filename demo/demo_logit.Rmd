...
text(-0.005,22,pos=4,cex=1.2,font=9,"Author, Year")
text(c(-0.0022,-0.0012),22,pos=4,cex=1.2,font=9,c("Cases", "Total"))
text(0.003,22,pos=4,cex=1.2,font=9,"Proportion [95% CI]")
