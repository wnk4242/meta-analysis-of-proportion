...
pes.logit.birthcohort=rma(yi,vi,data=ies.logit,subset=studydesign=="Birth cohort",method="REML")
pes.logit.others=rma(yi,vi,data=ies.logit,subset=studydesign=="Others",method="REML")
...
print(pes.birthcohort,digits=5);print(pes.logit.birthcohort,digits=5);confint(pes.logit.birthcohort,digits=5)
print(pes.others,digits=5);print(pes.logit.others,digits=5);confint(pes.logit.others,digits=5)
```
...
subganal.studydesign=rma(yi,vi,data=ies.logit,mods=~studydesign,method="REML")
