...
#Pool within-group estimates of tau-squared (between-study variance):0.4427 is the pooled value of tau^2
subganal.studydesign=rma(yi,vi,data=ies.logit,mods=~studydesign,method="DL")
pes.logit.subg=predict(subganal.studydesign)
pes.subg=predict(subganal.studydesign,transf=transf.ilogit)
dat.samevar=data.frame(estimate=c(pes.logit.subg[1]$pred,pes.logit.subg[17]$pred),
                       stderror=c(pes.logit.subg[1]$se,pes.logit.subg[17]$se),
...
#subganal.sizedesign=rma(yi,vi,data=ies.logit,mods=~samplesize+studydesign,method="DL")
```
