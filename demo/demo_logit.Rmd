...
print(pes,digits=6);print(pes.logit,digits=2);confint(pes.logit,digits=2)
print(pes.birthcohort,digits=6);print(pes.logit.birthcohort,digits=2);confint(pes.logit.birthcohort,digits=2)
print(pes.others,digits=6);print(pes.logit.others,digits=2);confint(pes.logit.others,digits=2)
```
...
pes.forest=metaprop(cases,total,author,data=dat,byvar=studytype,sm="PLO",method.ci="NAsm",method.tau="DL",incr=0.5,allincr=FALSE,addincr=FALSE,title="")
