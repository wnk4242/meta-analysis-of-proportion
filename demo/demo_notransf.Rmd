...
png("forestplot.png",width=500,height=500)
forest(pes,
...
text(-2,-1,pos=4,cex=0.8,font=1,bquote(paste("               (Q = ",.(formatC(pes$QE, digits=1, format="f")), ", df = ", .(pes$k - pes$p),", p = ", .(formatC(pes$QEp, digits=2, format="f")), "; ", I^2, " = ",.(formatC(pes$I2, digits=1, format="f")), "%",")")))
...
pes.summary=metaprop(cases,total,author,data=dat,byvar=province,sm="PRAW",method.ci="NAsm",method.tau="DL",incr=0.5,allincr=FALSE,addincr=FALSE,title="")
...
pes.province=rma(estimate,sei=stderror,method="DL",data=dat.samevar) #method="FE or other RE estimators"
